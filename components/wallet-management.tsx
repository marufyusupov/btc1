...
export function WalletManagement({ walletType }: { walletType: 'dev' | 'endowment' }) {
  const contractAddress = walletType === 'dev' 
    ? CONTRACT_ADDRESSES.DEV_WALLET 
    : CONTRACT_ADDRESSES.ENDOWMENT_WALLET
  
  const contractABI = walletType === 'dev' 
    ? ABIS.DEV_WALLET 
    : ABIS.ENDOWMENT_WALLET
          ...
          <div className="flex justify-between items-center">
            <div>
              <CardTitle className="flex items-center gap-2">
                ...
                {walletType === 'dev' ? 'Development Wallets' : 'Endowment Wallets'} Management
              </CardTitle>
              <CardDescription>
                Manage {walletType} wallet addresses
              </CardDescription>
            </div>
